  ...
  return (
    ...
    >
      <p className="mt-3">
        ...
        <a href="http://ugm.id/MVDataset" className="underline">http://ugm.id/MVDataset</a> and the
        "COVID-19 Radiography Database" dataset. The dataset contains x-ray
        images of normal people and people with COVID-19. It is calculated that
        the dataset contains 10,290 negative images and 3,674 positive images of
        COVID-19.
      </p>
